...
public class ObjectFactory {
    ...
    private final static QName _Query_QNAME = new QName("http://service.demo.example.com", "query");
    private final static QName _QueryResponse_QNAME = new QName("http://service.demo.example.com", "queryResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demo.example.com", name = "query")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.demo.example.com", name = "queryResponse")
